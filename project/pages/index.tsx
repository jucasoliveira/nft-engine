  ...
  <div className="bg-white">
    <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="grid grid-cols-2 gap-y-1 gap-x-0 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
            { generateImages && generateImages.map((elm, index) => <Card key={index} background={{
                  color: elm.randomBackground,
                  shape: 'square',
                }} ShapeStyleMapping={ShapeStyleMapping} DefaultBackgroundConfig={DefaultBackgroundConfig} 
